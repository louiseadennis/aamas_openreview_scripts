...
registration_forum = 'vSikVyOdps' #You find this by looking at the URL form?id=... when you click on the Reviewer Registration button....
...
for ac in ac_profiles:
    ...
    if (not flag):
        ...
        message = 'In order to match Senior Program Committee appropriately to papers we need you to complete our registration form with the area you are reviewing for.  In OpenReview you can find this in your Area Chair Console under Pending Tasks.  Please can you fill this in before we assign papers around the 10th October.  You should be able to find your area in your original invitation message.\n\n We also need you to confirm you will abide by our policy on the use of generative AI in reviews.  \n\n Many Thanks \n\n Louise & Chris'
        recipients = [ac.id]
